...
datamatrix.c DataMatrixEncoder.java datamatrix.cs datamatrix.js DataMatrix.pm: DataMatrixEncoder.ci
	cito -o $@ $<

clean:
	rm -f dmaa.exe DataMatrixAsciiArtEncoder.class DataMatrixEncoder.class dmaa-cs.exe datamatrix.c datamatrixci.cs datamatrixci.js DataMatrix.pm
